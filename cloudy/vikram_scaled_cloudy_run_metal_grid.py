...
def run_parallel(logZ, uvb_Q, uvb, scale_value):
    ...
    fname = (logZ+4)*100
    input_File = '/mnt/quasar2/abhisek/cloudy_run/rescaled_metal_NH15/try_{}_Q{}_Z{:.0f}.in'.format(uvb, uvb_Q, fname)
...
path = '/mnt/quasar2/abhisek/cloudy_run/rescaled_metal_NH15'
