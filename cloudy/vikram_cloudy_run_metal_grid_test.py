...
def run_parallel(logZ, uvb_Q, uvb):
    # for abhisek
    cloudy_path = '/home/abhisek/c17.02'
    fname = (logZ+4)*100
    input_File = '/home/abhisek/cloudy_run/metal_NH15/try_{}_Q{}_Z{:.0f}.in'.format(uvb, uvb_Q, fname)
...
path = '/home/abhisek/cloudy_run/metal_NH15/'
...
uvb_Q=19
cloudy_path = '/home/abhisek/c17.02'
input_File = '/home/abhisek/cloudy_run/try.in'
