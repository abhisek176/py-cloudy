...
for q_num in q:
    model = '/home/abhisek/cloudy_run/anshuman_NH15/try_Q{}.fits'.format(q_num)
...
model ='/home/abhisek/cloudy_run/anshuman/try_Q14.fits'
ions= ['C+3', 'C+2', 'Si+3', 'Si+2', 'O+5']

#nH, Z, array= find_nH_and_Z_LSF(model, *ions)

model ='/home/abhisek/cloudy_run/anshuman/try_Q20.fits'
...
for q_num in q:
    model = '/home/abhisek/cloudy_run/anshuman/try_Q{}.fits'.format(q_num)
...
print('for NH = 16')
for q_num in q:
    model = '/home/abhisek/cloudy_run/anshuman_NH16/try_Q{}.fits'.format(q_num)
    nH, Z, min_LS= find_nH_and_Z_LSF(model, *ions)
    print(q_num, nH, Z, min_LS/len(ions), np.log10(np.sqrt(min_LS/len(ions))))
...
model ='/home/abhisek/cloudy_run/anshuman/try_Q19.fits'
solution  = bootstrap_error(model, *ions, sample_size= s)
model ='/home/abhisek/cloudy_run/anshuman/try_Q18.fits'
solution  = bootstrap_error(model, *ions, sample_size= s)
model ='/home/abhisek/cloudy_run/anshuman/try_Q17.fits'
solution  = bootstrap_error(model, *ions, sample_size= s)
model ='/home/abhisek/cloudy_run/anshuman/try_Q16.fits'
solution  = bootstrap_error(model, *ions, sample_size= s)
model ='/home/abhisek/cloudy_run/anshuman/try_Q15.fits'
solution  = bootstrap_error(model, *ions, sample_size= s)
model ='/home/abhisek/cloudy_run/anshuman/try_Q14.fits'
solution  = bootstrap_error(model, *ions, sample_size= s)
